...
class TestMPO(unittest.TestCase):
    ...
    def test_orthonormalization(self):
        ...
        d = 4
        D = [1, 10, 13, 14, 7, 1]
        mpo0 = ptn.fMPO(np.random.randint(2, size=d), [np.random.randint(2, size=Di) for Di in D], fill='random')
    ...
    def test_identity(self):
        ...
        qd = np.random.randint(2, size=d)

        # construct MPO representation of identity
        idop = ptn.fMPO.identity(qd, L)
    ...
    def test_from_opchains(self):
        ...
        for _ in range(n):
            ...
            qD = np.random.randint(2, size=length-1)
        ...
        mpo0 = ptn.fMPO.from_opchains(qd, L, opchains)
    ...
    def test_add(self):
        ...
        # physical quantum numbers
        qd = np.random.randint(2, size=3)

        # create random matrix product operators
        qD0 = [np.random.randint(2, size=Di) for Di in [1, 11, 15, 23, 18, 9, 1]]
        ...
        qD1[ 0] = qD0[ 0].copy()
        qD1[-1] = qD0[-1].copy()
        op0 = ptn.fMPO(qd, qD0, fill='random')
        op1 = ptn.fMPO(qd, qD1, fill='random')
    ...
    def test_add_singlesite(self):
        ...
        op0 = ptn.fMPO(qd, qD, fill='random')
        op1 = ptn.fMPO(qd, qD, fill='random')
    ...
    def test_multiply(self):
        ...
        # create random matrix product operators
        op0 = ptn.fMPO(qd, [np.random.randint(2, size=Di) for Di in [1, 10, 13, 24, 17, 9, 1]], fill='random')
        op1 = ptn.fMPO(qd, [np.random.randint(2, size=Di) for Di in [1, 8, 17, 11, 23, 13, 1]], fill='random')
