import numpy as np
from .fmps import fMPS, local_orthonormalize_left_qr, local_orthonormalize_right_qr, merge_mps_tensor_pair, split_mps_tensor
from .fmpo import fMPO, merge_mpo_tensor_pair
...
def calculate_ground_state_local_singlesite(H: fMPO, psi: fMPS, numsweeps: int, numiter_lanczos: int = 25):
    """
...
def calculate_ground_state_local_twosite(H: fMPO, psi: fMPS, numsweeps: int, numiter_lanczos: int = 25, tol_split: float = 0):
    """
